...
import psycho.euphoria.tools.KEY_MEDIUM
...
class VideoFragment : ViewPagerFragment(), TextureView.SurfaceTextureListener,
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        storeStateVariables()
        medium = arguments!!.getSerializable(KEY_MEDIUM) as Medium
    ...
    fun playVideo() {
        ...
        mView!!.video_play_outline.setImageResource(R.mipmap.ic_pause)
    ...
    private fun pauseVideo() {
        ...
        mView?.video_play_outline?.setImageResource(R.mipmap.ic_play)
